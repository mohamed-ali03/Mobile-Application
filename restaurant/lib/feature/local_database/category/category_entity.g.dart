...
extension CategoryEntityQuerySortBy
  ...
  QueryBuilder<CategoryEntity, CategoryEntity, QAfterSortBy> sortByImageUrl() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryEntityQuerySortThenBy
  ...
  QueryBuilder<CategoryEntity, CategoryEntity, QAfterSortBy> thenByImageUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imageUrl', Sort.asc);
    });
  }
...
extension CategoryEntityQueryWhereDistinct
  ...
  QueryBuilder<CategoryEntity, CategoryEntity, QDistinct> distinctByImageUrl(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryEntityQueryProperty
  ...
  QueryBuilder<CategoryEntity, String, QQueryOperations> imageUrlProperty() {
    return QueryBuilder.apply(this, (query) {
